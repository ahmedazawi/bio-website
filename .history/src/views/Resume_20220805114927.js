  ...
  return (
    ...
    >
      ...
      >
        <h1>Online Resume</h1>
        <a
          href="https://drive.google.com/file/d/15pAaGeQzM7rIs7e_jr2EU6NALuMMxu7G/view?usp=sharing"
          style={{
            textDecoration: "none",
          }}
        >
          ...
          <div className="resume-section-one">
            ...
            <div>
              <div className="resume-inside-title">
                <big>Data Warehouse Manager</big>
                <small>Full-time | 2022 - Present</small>
              </div>
              <p>
                Working as a Data Warehouse Manager at <b>Breeze Air</b>. My Job
                includes :
              </p>
              <ul
                style={{
              ...
              >
                <li>Managing the Warehouse Management System.</li>
                <li>
                  Responsible for all company items and reorganize it to the
                  Warehouses.
                </li>
                <li>
                  Managing the Social media and Creating the Company advertising
                  Designs.
                </li>
                <li>Purchasing officer.</li>
                <li>
                  Managing the Fingerprints attendance System for all workers.
                </li>
              </ul>
            </div>
            <br />
            <div>
              <div className="resume-inside-title">
                ...
                <small>Part-time | 2021 - 2022</small>
              </div>
              <p>
                Working as a front end developer at <b>Msmar Group</b>. My Job
                includes :
              </p>
              <ul
                style={{
              ...
              >
                <li>Creating the Front End Side of all Projects.</li>
                <li>
                  Creating the Ui Designs for the Projects and Discuss it with
                  the Clients.
                </li>
          ...
          <div className="resume-section-two">
            ...
            <div className="section-two-divs">
              <ul>
                ...
                <li>
                  Basic knowledge of MySQL , Node Js (Express Js) , Bootstrap 4
                  and C++.
                </li>
                <li>UI Web Designer in figma</li>
                <li>Microsoft Office 365</li>
                <li>Warehouse Management System</li>
                <li>Adobe Photoshop ,illustrator on iPad</li>
              </ul>
            </div>
            <div className="resume-title">
              <div></div>
            ...
            <div className="section-two-divs">
              <ul>
                <li>
                  Certificate of Completion the React.js (Redux,Hooks,Routers)
                  from udemy
                </li>
                <li>
